        ...
        DOMAIN: vol.Schema(
            {
                ...
                vol.Optional(CONF_AUTO_FORCAST, default=False): cv.bool,
                vol.Optional(CONF_API_LIMIT, default=10): cv.integer,
                vol.Optional(CONF_API_LIMIT, default=False): cv.bool,
            }
        )
    },
